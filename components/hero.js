...
<div className="md:flex md:justify-center bg-cover w-full bg-center place-items-center	 h-max bg-base-100 pt-11 -z-0 pb-10">
  <div className="hero-content flex-col lg:flex-row-reverse">
    <Image src="/bot.jpg" className=" rounded-lg shadow-2xl" width={450} height={650} alt="bot"/>
