...
const Privacy = () => {
    ...
    <div className="flex flex-col pt-6 md:px-0 px-6">
      ...
      <div className="text-justify md:px-28 space-y-4 text-black text-[17px]">
        <p>The following terms of the privacy policy (“Privacy Policy”) are by and between VMS Media Private Limited, 
          a company duly incorporated in India (“Company”), which runs and operates www.unstumbled.com (“Website”/“We”/“Our”/”Us”)
           ...
           <p>This Privacy Policy shall be effective at the time You access the Website to avail of its Services.</p>
           <p>If You do not agree to be bound by the terms of this Privacy Policy as set out below, You may not access the Website.</p>
          <p className="font-semibold">Interpretation and Definitions</p>

          <p className="font-semibold">Interpretation</p>
          <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in the singular or plural.</p>
      ...
      <p>“Company” (referred to as &apos;the Company&apos; in this Agreement) refers to VMS Media Private Limited, having its registered address at Unique Centre, First Floor, Waterfield Road, Bandra West, Mumbai 400050.</p>
...
We may use cookies to store information, such as your personal preferences when you visit our site. This could include only showing you a popup once in your visit, or the ability to login to some of our features, such as forums.

We may also use third-party advertisements on .com to support our site. Some of these advertisers may use technology such as cookies and web beacons when they advertise on our site, which will also send these advertisers (such as Google through the Google AdSense program) information including your IP address, your ISP, the browser you used to visit our site, and in some cases, whether you have Flash installed. This is generally used for geotargeting purposes or showing certain ads based on specific sites visited (such as showing cooking ads to someone who frequents cooking sites).
...
We may use both Session and Persistent Cookies for the purposes set out below:</p>
...
<p>For more information about the cookies we use and your choices regarding cookies, please visit our Cookies Policy or the Cookies section of our Privacy Policy.</p>
      ...
      <p><span className="font-semibold">To manage Your Account:</span> to manage Your registration as a user of the Service. The Personal Data You provide can give You access to different functionalities of the Service that are available to You as a registered user.</p>
      <p><span className="font-semibold">For the performance of a contract:</span> the development, compliance, and undertaking of the purchase contract for the products, items, or services You have purchased or of any other contract with Us through the Service.</p>
      ...
      <p><span className="font-semibold">To manage Your requests: </span>To attend to and manage Your requests to Us.</p>
      ...
      <p><span className="font-semibold">For other purposes:</span>We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns, and evaluating and improving our Service, products, services, marketing, and your experience.</p>
      <p className="font-semibold">We may share Your personal information in the following situations:</p>
      <p><span className="font-semibold">With Service Providers: </span>We may share Your personal information with Service Providers to monitor and analyze the use of our Service, to contact You.</p>
      <p><span className="font-semibold">For business transfers:</span>We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company.</p>
      ...
      <p><span className="font-semibold">With business partners: </span>We may share Your information with Our business partners to offer You certain products, services, or promotions.</p> 
      <p><span className="font-semibold">With other users:</span>when You share personal information or otherwise interact in public areas with other users, such information may be viewed by all users and may be publicly distributed outside. If You interact with other users or register through a Third-Party Social Media Service, Your contacts on the Third-Party Social Media Service may see Your name, profile, pictures, and description of Your activity. Similarly, other users will be able to view descriptions of Your activity, communicate with You, and view Your profile.</p> 
      <p><span className="font-semibold">With Your consent: </span>We may disclose Your personal information for any other purpose with Your consent.</p>
     ...
     <p className="font-semibold">Transfer of Your Personal Data</p>
     ...
     <p className="font-semibold">Disclosure of Your Personal Data</p>
     ...
     <p>Our Service does not address anyone under the age of 13. We do not knowingly collect personally identifiable information from anyone under the age of 13. If You are a parent or guardian and You are aware that Your child has provided Us with Personal Data, please contact Us. If We become aware that We have collected Personal Data from anyone under the age of 13 without verification of parental consent, We take steps to remove that information from Our servers.</p>
      ...
      <p className="font-semibold">Our Service may contain links to other websites that are not operated by Us. If You click on a third-party link, You will be directed to that third party&spos;s site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
      ...
      <p className="pb-10">By using the Unstumbled Platform and the Services provided therein, you agree and consent to the collection, transfer, use, storage, disclosure, and sharing of your information as described and collected by us in accordance with this Policy. If you do not agree with the Policy, please do not use or access the Unstumbled Platform.</p>
